        ...
        <div className="grid gap-12 lg:grid-cols-12">
          <div className="lg:col-span-5">
            ...
            <p className="mt-5 font-light leading-7 text-cream/62">
              ...
              responsibility in the cupboard. These six habits keep the packet honest until the last spoon.
            </p>
            <div className="mt-8 overflow-hidden border border-[rgba(196,163,90,0.22)]">
              <img src="/images/storage-jars.png" alt="Airtight packets stored in a dark pantry" className="h-64 w-full object-cover" />
            </div>
          </div>
