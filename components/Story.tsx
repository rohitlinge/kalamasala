        ...
        <div className="grid gap-8 md:grid-cols-12">
          ...
          <div className="md:col-span-7">
            <p className="text-[14px] leading-6 text-[#0f1111]">
              ...
              flower, and the quiet heat of pepper. <strong>Lata Special</strong> is our kitchen name for it: the
            ...
            <p className="mt-3 text-[14px] leading-6 text-[#565959]">
              ...
              first — a true kala, not a dyed grey — and then the finish: nutty, warm, and clean, the way a Nagpur usal
              should taste.
            </p>
